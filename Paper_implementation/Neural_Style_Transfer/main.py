...
if __name__ == "__main__":
    ...
    original_image = image_loader("Paper_implementation/Neural_Style_Transfer/content_image.jpg")
    style_image = image_loader("Paper_implementation/Neural_Style_Transfer/style_image.jpg")
